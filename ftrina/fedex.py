	...
	CONFIG_OBJ = FedexConfig(key='xCkQD7brtB51yZg0',
                         password='fpCwEMPh8M8VusZn7d60zbxN8',
                         account_number='568020634',
                         meter_number='112737878')
	...
	rate_request.RequestedShipment.ServiceType = 'INTERNATIONAL_ECONOMY'
	...
	rate_request.RequestedShipment.Shipper.Contact.PersonName = 'Wael El-begearmi'
	rate_request.RequestedShipment.Shipper.Contact.CompanyName = 'Ftrina Limited'
	rate_request.RequestedShipment.Shipper.Contact.PhoneNumber = '6063 9234'
	rate_request.RequestedShipment.Shipper.Address.StreetLines = ['Room 907, Sillvercord tower 2, 30 canton Rd.']
	rate_request.RequestedShipment.Shipper.Address.City = 'Kawloon'
	rate_request.RequestedShipment.Shipper.Address.StateOrProvinceCode = None
	rate_request.RequestedShipment.Shipper.Address.PostalCode = '000000'
	rate_request.RequestedShipment.Shipper.Address.CountryCode = 'HK'
	rate_request.RequestedShipment.Shipper.Address.Residential = False

	#shipmentOriginCountry

	# Recipient address
	rate_request.RequestedShipment.Recipient.Address.PostalCode = '11311'
	rate_request.RequestedShipment.Recipient.Address.CountryCode = 'EG'
