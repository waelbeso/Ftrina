...
class UserEmailConfirmation(object):
    """
    ...
    @property
    def email_confirmation_key(self):
        """
        ...
        return self.get_email_confirmation_key(email)
    ...
    def get_email_confirmation_key(self, email=None):
