 ...
 *********************/
function init () {
    var ratingActions = document.querySelectorAll(".ratings-rate-action"),
        i;
...
function bindRatings(el) {
    ...
    el.onmouseenter = function () {
        ...
        var parent = utils.findParent(this, "ratings");
        parent.querySelector(".ratings-rating-foreground").style.width = 100 / maxRating * score + "%";
    };
    ...
    el.onmouseleave = function () {
        ...
        parent.querySelector(".ratings-rating-foreground").style.width = percentage;
    };
}
...
function updateRating(rating, sender) {
    ...
    parent.querySelector(".ratings-rating-foreground").style.width = rating.percentage + '%';
}
...
function showError (errors, sender) {
    ...
    parent.querySelector(".ratings-errors").innerHTML = errors.error;
    setTimeout(function () {
        parent.querySelector(".ratings-errors").innerHTML = "";
    }, 2500);
}
